...
NewFileInclude2=#include "输出2行字.h"
LastPage=0
...
Type=0
HeaderFile=输出2行字.h
ImplementationFile=输出2行字.cpp
Filter=N

[CLS:CMy2Doc]
Type=0
HeaderFile=输出2行字Doc.h
ImplementationFile=输出2行字Doc.cpp
Filter=N

[CLS:CMy2View]
Type=0
HeaderFile=输出2行字View.h
ImplementationFile=输出2行字View.cpp
Filter=C
